...
export default function Reception() {
  ...
  return (
    <div className="reception-page">
      ...
      {/* Modal إضافة مريض بتصميم احترافي وأنيق */}
      {showModal && (
...
//   // مصفوفة الكروت لتجنيب التكرار
//   const stats = [
//     {
//       title: "Today's Appointments",
//       count: patients.length + 20,
...
//               <h3>{s.count}</h3>
//               <span className={`stat-sub ${s.isLink ? "link" : ""}`}>
//                 {s.sub}
//               </span>
//             </div>
//           </div>
...
//                   {activeMenu === p.id && (
//                     <div className="menu-dropdown">
//                       {["Waiting", "In Progress", "Completed"].map((st) => (
//                         <div key={st} onClick={() => updateStatus(p.id, st)}>
//                           {st}
//                         </div>
//                       ))}
//                     </div>
